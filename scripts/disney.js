...
function slideScreen(direction){
	switch (direction){
		case 1:
			$.mobile.changePage( "#four", { transition: "fade"} );	
		break;
		case 2:
			$.mobile.changePage( "#six", { transition: "fade"} );
		break;
		case 3:
			$.mobile.changePage( "#two", { transition: "fade"} );
  		break;
		case 4:
			$.mobile.changePage( "#three", { transition: "fade"} );
  		break;
		case 5:
